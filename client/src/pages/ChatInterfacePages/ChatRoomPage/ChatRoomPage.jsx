...
const ChatRoomPage = () => {
  ...
  const fetchOrderDetails = async () => {
    try {
      const response = await axios.get(`http://127.0.0.1:8800/orders/${orderId}`);
  ...
  const fetchPreviousMessages = async () => {
    try {
      const response = await axios.get(`http://127.0.0.1:8800/orders/${orderId}/messages`);
  ...
  const handleAccept = async () => {
    try {
      await axios.put(`http://127.0.0.1:8800/api/orders/${orderId}/accept`);
      fetchOrderDetails();
    } catch (error) {
  ...
  const handleDecline = async () => {
    try {
      await axios.put(`http://127.0.0.1:8800/api/orders/${orderId}/decline`);
      fetchOrderDetails();
    } catch (error) {
  ...
  const handleCancel = async () => {
    try {
      const response = await axios.put(`http://127.0.0.1:8800/api/orders/${orderId}/cancel`, {
        code: cancelCode,
  ...
  const handleFulfill = async () => {
    try {
      const response = await axios.put(`http://127.0.0.1:8800/api/orders/${orderId}/fulfill`, {
        code: fulfillCode,
        userType: user.userType
      });
